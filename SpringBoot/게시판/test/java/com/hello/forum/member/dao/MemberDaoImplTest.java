...
public class MemberDaoImplTest {
	...
	public void getEmailCountTest() {
		...
		count = this.memberDao.getEmailCount("test2@naver.com");
...
//		int insertedCount = this.memberDao.createNewMember(memberVO);
		...
		DataIntegrityViolationException exception = Assertions.assertThrows(DataIntegrityViolationException.class, ()->this.memberDao.createNewMember(memberVO));
	...
	public void createNewMemberFailDupEmailTest() {
		...
		memberVO.setSalt("sdsdgsdgsdg");
		
		DuplicateKeyException exception = Assertions.assertThrows(DuplicateKeyException.class, ()->this.memberDao.createNewMember(memberVO));
