...
public class TimingAspect {
	...
	/**
	 * AOP를 적용할 대상을 지정
	 * execution() : 실행 단계에서 적용할 대상을 지정
	 *   public : public 접근 제어자를 사용하는 것을 대상으로 한다.
	 *   * : 모든 반환타입을 대상으로 한다.
	 *   com.hello.forum..service.*ServiceImpl : com.hello.forum 아래에 있는 모든 패키지 중에서 service 패키지 내부에 있는 ServiceImpl로 끝나는 모든 클래스를 대상으로 한다.
	 ...
	 * 아래 메소드가 실행된다. - Weaving 된 코드가 실행된다. 
...
//	@AfterReturning
//	@AfterThrowing
	@Around("aroundTarget()") // 위의 것들 다 포함
